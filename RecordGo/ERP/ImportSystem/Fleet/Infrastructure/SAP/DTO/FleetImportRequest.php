...
final class FleetImportRequest
{
    ...
    public static function mapper(array $fleetImport): array
    {
        return [
            ...
            // 'MOTOR' => $fleetImport['motor'],
            // 'MOTORDENOMINATION' => $fleetImport['motorDenomination'],
            // 'KW' => $fleetImport['kw'],
            ...
            // 'INSURANCECANCELATIONDATE' => $fleetImport['cancelationDate'] ? Utils::formatTimestampToOdataDate($fleetImport['cancelationDate']) : null,
