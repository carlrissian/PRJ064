...
use Pricing\ModificationPolicy\Application\EditModificationPolicy\EditModificationPolicyQuery;
use Pricing\ModificationPolicy\Application\EditModificationPolicy\EditModificationPolicyQueryHandler;
use Pricing\ModificationPolicy\Application\EditModificationPolicy\EditModificationPolicyResponse;
...
use Pricing\ModificationPolicy\Domain\ModificationPolicyNotFoundException;
use Pricing\ModificationPolicy\Domain\ModificationPolicyRepository;

class EditModificationPolicyQueryHandlerTest extends TestCase
{
    /**
    ...
    /**
     * @var EditModificationPolicyQueryHandler
     */
    private $editModificationPolicyQueryHandler;

    public function setUp()
    {
        $this->modificationPolicyRepository = $this->createMock(ModificationPolicyRepository::class);
        $this->editModificationPolicyQueryHandler = new EditModificationPolicyQueryHandler($this->modificationPolicyRepository);
    }

    /**
     * @test
     * @throws CheckComplementInvalidArgumentException
     * @throws ModificationPolicyNotFoundException
     */
    public function should_return_edit_modification_policy_response_object()
    {
        ...
        $response = $this->editModificationPolicyQueryHandler->handle(
            new EditModificationPolicyQuery(
                1
            )
        );

        $this->assertInstanceOf(EditModificationPolicyResponse::class, $response);
